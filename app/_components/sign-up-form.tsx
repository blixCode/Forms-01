        ...
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)}>
            <CardContent className="p-6 space-y-5">
              <h2 className="text-2xl font-semibold text-purple-700 mb-6">Inscription</h2>
              <div className="grid grid-cols-2 gap-4">
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel className="text-purple-700">Prénom</FormLabel>
                      <FormControl>
                        <Input
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel className="text-purple-700">Nom</FormLabel>
                      <FormControl>
                        <Input
                    ...
                    <FormControl>
                      <div className="relative">
                        <Input
                          ...
                          {...field}
                          className="rounded-xl border-2 border-purple-700 focus-visible:ring-purple-700 pr-10 h-12  placeholder-gray-100"
                        />
                        <Button
                          type="button"
                          variant="ghost"
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel className="text-purple-700">Date de naissance</FormLabel>
                    <FormControl>
                      <Input
                        type="date"
                        placeholder="Le jour de votre naissance"
                        {...field}
                        className="rounded-xl border-2 border-purple-700 focus-visible:ring-purple-700 h-12"
                      />
                    </FormControl>
